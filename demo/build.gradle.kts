...
plugins {
    ...
    id("com.improve_future.jarmonica") version "3.0.2"
}
...
dependencies {
    implementation("com.improve_future:gradle-plugin:3.0.2")
    implementation("com.improve_future:core:3.0.2")
    harmonica("com.improve_future:exposed:3.0.2")
